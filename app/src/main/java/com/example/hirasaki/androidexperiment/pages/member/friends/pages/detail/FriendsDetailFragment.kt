package com.example.hirasaki.androidexperiment.pages.member.friends.pages.detail
...
class FriendsDetailFragment : Fragment() {
    ...
    */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.member_friends_detail, container, false)
    }
