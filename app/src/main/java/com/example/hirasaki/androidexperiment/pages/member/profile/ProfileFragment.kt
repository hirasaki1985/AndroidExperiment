package com.example.hirasaki.androidexperiment.pages.member.profile
...
import com.example.hirasaki.androidexperiment.pages.member.profile.profile.ProfileProfileIndexFragment
...
import com.example.hirasaki.androidexperiment.pages.member.profile.feed.ProfileFeedIndexFragment
import com.example.hirasaki.androidexperiment.pages.member.profile.reference.ProfileReferenceIndexFragment
import com.example.hirasaki.androidexperiment.pages.member.profile.utils.ProfilePresenter
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return  inflater.inflate(R.layout.member_fragment_profile, container, false)
    }
